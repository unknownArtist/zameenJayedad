...
<h1>Quotes to Build your House</h1>


<div id="form-wrapper">
<div class="bahriaupdate">
<h3>Get A free Quote to Build your house!!</h3>
<p>Complete this form to find out the best quote to build your house.</p>
 
</div>
{{ Form::open(array('url' => 'dashboard/buildhouse')) }}
